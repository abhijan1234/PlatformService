...
namespace PlatformServiceAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IPlatformServiceRepository, PlatformServiceRepository>();

            services.AddDbContextPool<DataContext>(
                o => o.UseNpgsql(Configuration["ConnectionStrings:DbString"])
                );
